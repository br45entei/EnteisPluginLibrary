...
/**This is a customized exception created by <a href="http://enteisislandsurvival.no-ip.org/about/author.html">Brian_Entei</a> to handle this plugins' errors when dealing with the configuration files.
 * @since 0.1
...
public class InvalidYamlException extends Exception {
	/**Link to <a href="http://docs.oracle.com/javase/7/docs/api/java/io/Serializable.html">Serializable</a>
	 * @author Brian_Entei*/
